...
- **Native Completion Notifications**: Bridges hidden WebUI completion alerts into Android system notifications and runs lightweight native background checks for completed agent responses and cron runs, with Android-specific notification settings in the app bar.
